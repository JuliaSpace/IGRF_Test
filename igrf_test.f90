...
program igrf_test
    ...
    open(unit=1, file="IGRF12_test_geocentric.txt", form="formatted", action="write")
    open(unit=2, file="IGRF12_test_geodetic.txt",   form="formatted", action="write")

    do i = 1,2000
        ! Geocentric coordinates
        ! ======================

        date  = real(nint( (1900.0_dp + (2020.0_dp - 1900.0_dp)*rand())*10 ) )/10
